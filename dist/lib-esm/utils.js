export function xlsx_date(value, date1904, ignore_timezone) {
...
export function containsOnlyChars(value, chars) {
...
export function splitCellFormats(s) {
    var fmts = s.split(/(?!\\);/);
    var nr = 0;
    var last = { t: 'x' };
    var result = [];
...
export function getColumnFromDef(colDef) {
    var cc = '';
...
export function escapeTSV(val, options) {
